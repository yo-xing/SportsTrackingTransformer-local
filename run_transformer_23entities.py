...
def main():
    ...
    print("\n" + "="*60)
    print("Transformer Training Pipeline (23 Entities: 22 Players + Football)")
    print("="*60 + "\n")

    # Use separate cache directories for 23-entity training
    # This prevents overwriting existing 22-player caches
    drive_cache_prep = "/content/drive/MyDrive/ExtraDataSportsTrackingTransformer_cache_gamestate_23"
    drive_cache_datasets = "/content/drive/MyDrive/NewDataSportsTrackingTransformer_cache_gamestate_23"
    local_output_prep = "data/split_prepped_data_extra_gamestate_23"
    local_output_datasets = "data/datasets_extra_gamestate_23"
    local_output_models = "models_gamestate_23"
    ...
    run_command(
        ...
        f"--batch-size 512 --num-workers {num_workers}",  # Increased for A100 (2x speedup)
        "Stage 3/5: Training transformer models"
    )

    # Stage 4: Backup trained models to Google Drive
    drive_models_dir = "/content/drive/MyDrive/SportsTrackingTransformer/models_gamestate_23"
    from pathlib import Path
