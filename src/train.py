...
def train_model(
    ...
    # Note: num_workers reduced to 2 to prevent hanging in Colab/limited environments
    train_dataloader = DataLoader(train_ds, batch_size=batch_size, shuffle=True, pin_memory=True, num_workers=2)
    val_dataloader = DataLoader(val_ds, batch_size=1024, shuffle=False, pin_memory=True, num_workers=2)
